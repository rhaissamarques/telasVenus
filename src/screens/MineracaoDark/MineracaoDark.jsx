...
import "./styleMineracao.css";
import { useNavigate } from "react-router-dom";

export function MineracaoDark() {
          ...
          <div className="div">
            ...
            <div className="tela-mineracao">
              <img
                ...
                alt="Uso tela mineracao"
                src="src\components\images\mineracao3.svg"
              />
    
              <img
                className="concreto-tabela"
                alt="Pilhas tela mineracao"
                src="src\components\images\mineracao2.svg"
              />
    
              <img
                className="concreto-detalhe"
                alt="Mineracao"
                src="src\components\images\mineracao1.svg"
              />
    
              <div className="overlap-group">
                <div className="text-wrapper-2">Tela Mineração</div>
